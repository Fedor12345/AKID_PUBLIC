...
//            }
            ...
            delegate:
                ...
                onClicked: {
                    ...
                    var id_currentPerson = modeles.model_ext_person_list.getId(index)
                    ...
                    workersModel.query = " SELECT W_SURNAME, W_NAME, W_PATRONYMIC, PERSON_NUMBER,
                                           ...
                                           FROM ext_person
                                           LEFT JOIN adm_status ON ext_person.STATUS_CODE = adm_status.STATUS_CODE
                                           WHERE ext_person.ID_PERSON = " + id_currentPerson;

                }
            }

            highlight: Rectangle {
                color: "#B0BEC5" //Material.color(Material.Grey, Material.Shade700)
//                Image {
//                    id: idrop
//                    width: 24
//                    height: 24
