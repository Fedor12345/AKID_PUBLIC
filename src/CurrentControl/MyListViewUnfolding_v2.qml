...
Rectangle {
    ...
    property bool folding: true /// true - умеет сворачиваться и разворачиваться
    ...
    ListView {
        ...
        delegate:  ItemDelegate {
                      ...
                      height: {
                          if (header === "") { mainText.height + 20 }
                          else                { shown ? (mainText.height + 20) : 0 }
                      }
                      ...
                      Rectangle {
                          ...
                          anchors.leftMargin: 40  //(header === "") ? 20 : 35
                          width: 30
                          height: 30
                          border.color: "white"
                      ...
                      Text {
                          ...
                          anchors.verticalCenter: parent.verticalCenter
                          anchors.left: parent.left
                          anchors.leftMargin: 80 //(header === "") ? 35 : 50
                          text: name;
        ...
        section.delegate: ItemDelegate {
                              ...
                              height:  (section === "") ? 0 : txt1.height + 30 //childrenRect.height
...
//                              }
                              ...
                              Item {
                                  ...
                                  opacity: {
                                      var str = section;
                                      return (~str.indexOf("not fold")) ? 0 : 1
                                  }
    ...
    //                                  sourceSize.width:  14
                              ...
                              Text {
                                  ...
                                  text: {
                                      var str = section;
                                      /// если в моделе в свойстве header помоимо названия заголовка написанно "not fold",
                                      /// то удаляем ее из текста заголовка
                                      if(~str.indexOf("not fold")) {
                                        str = str.replace("not fold","");
                                      }
                                      return str; //section
                                  }
                                  font.pixelSize: 20;
                              ...
                              onClicked: {
                                  ...
                                  var str = section;
                                  /// если в моделе в свойстве header помоимо названия заголовка написанно "not fold",
                                  /// то отключаем возможность сворачивать и разворачивать подкатегорию
                                  if (!~str.indexOf("not fold")) {
