...
private:
    ...
    QVector<QVector<QByteArray>> byteValues; /// двумерный массив для хранения данных не являющихся строкой или числом (например побитовое представление файлов с фото)
